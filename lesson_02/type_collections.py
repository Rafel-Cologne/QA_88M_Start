# list
from lesson_01.type_strings import coordinates
...
del person["city"]  # удалить через "del"
print(person)

print("name" in person)  # поиск через "in"
...
unique_names = set(names) # "unique" - сортирует, оставляет только уникальные имета. Убрал дубликаты
print(unique_names)

set1 = {1, 2, 3, 4}
set2 = {3, 4, 5, 6}
print(set1 | set2)  # "|" -  объединить
